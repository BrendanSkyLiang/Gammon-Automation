...
for a in range(357):
    ...
    current1[4] = 0
    # current1[6] = abs(current1[6])
    # current1[7] = abs(current1[7])
    # current1[8] = abs(current1[8])
    # current1[9] = abs(current1[9])
    # current1[10] = abs(current1[10])
    # current1[11] = abs(current1[11])
